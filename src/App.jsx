    ...
    return (
      <div className="pg-content">
        ...
        <div className="pg-content-footer">
          <p>Pigs-UI</p>
          <a  href="https://github.com/sunyuhang404/pigs-ui" target="_blank">
            <svg className="pg-content-footer_icon" height="32" viewBox="0 0 16 16" version="1.1" width="32" aria-hidden="true">
